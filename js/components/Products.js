Vue.component('products', {
  ...
  mounted() {
    this.$parent.getJson(this.productsUrl).then((data) => {
  ...
  template: `<div class="products__content">
...
Vue.component('card', {
  ...
  template: `<article class="card card_vertical">
    <div class="card__image">
      <img :src="product.img" alt="product image" />
      <div class="card__overlay">
        <button class="card__btn" @click="$emit('add-product', product)">
          <svg
            width="32"
            height="29"
            viewBox="0 0 32 29"
